...
namespace Wizards.Infrastructure.Migrations
{
    ...
    [Migration("20260815054846_LinkEventGameTypeSelectionsToSettings")]
    partial class LinkEventGameTypeSelectionsToSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wizards.Infrastructure.Persistence.Records.EventGameTypeSelection", b =>
                {
                    ...
                    b.HasIndex("GameTypeSettingId");

                    b.HasIndex("EventId", "GameTypeSettingId")
                        .IsUnique();
